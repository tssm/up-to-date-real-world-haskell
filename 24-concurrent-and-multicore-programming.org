...
[[file:concurrent-and-multicore-programming.html#concurrent.strategies][the section called “Separating algorithm from evaluation”]]
below.
...
[[file:concurrent-and-multicore-programming.html#concurrent.useful.nonstrict][the section called “MVar and Chan are non-strict”]] particularly relevant.
...
[[file:software-transactional-memory.html][Chapter 28, /Software transactional memory/]].
...
[[file:io-case-study-a-library-for-searching-the-filesystem.html#find.fold][the section called “Another way of looking at traversal”]] to
...
in [[file:interfacing-with-c-the-ffi.html][Chapter 17, /Interfacing with C: the FFI/]].
