...
[[file:efficient-file-processing-regular-expressions-and-file-name-matching.html][Chapter 8, /Efficient file processing, regular expressions, and file name matching/]].
...
[[file:functional-programming.html#fp.infix][the section called “Infix functions”]] for more information on backticks.
#+END_TIP
...
- All of these three types are members of the ~Eq~, ~Ord~, ~Read~,
  ...
  [[file:using-typeclasses.html#typeclasses.wellknown][the section called “Important Built-In Typeclasses”]].
