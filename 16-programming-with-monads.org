...
[[file:15-monads.org::*The Monad typeclass][the section called "The Monad typeclass"]]
...
[[file:6-using-typeclasses.org::*JSON typeclasses without overlapping instances][the section called "JSON typeclasses without overlapping instances"]]
