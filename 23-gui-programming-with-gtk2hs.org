...
[[file:extended-example-web-client-programming.html][Chapter 22, /Extended Example: Web Client Programming/]]. Our first
...
found in
[[file:concurrent-and-multicore-programming.html][Chapter 24, /Concurrent and multicore programming/]]. For now, just know that
...
[[file:extended-example-web-client-programming.html][Chapter 22, /Extended Example: Web Client Programming/]] to make it work as a GUI.
