...
compiler. This can easily lead us astray. #*END_TIP
...
into one. In [[file:functional-programming.html#fp.fold.exercises][the section called “Exercises”]], we mentioned that we
