...
We'll use HDBC (see [[file:using-databases.html][Chapter 21, /Using Databases/]])
...
[[file:using-databases.html#databases.hdbc.install][the section called “Installing HDBC and Drivers”]].
...
[[file:writing-a-library-working-with-json-data.html#library.package][the section called “Creating a package”]] to build this project:
